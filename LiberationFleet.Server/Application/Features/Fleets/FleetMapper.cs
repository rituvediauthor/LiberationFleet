...
public static class FleetMapper
{
    public static FleetDto MapFleet(Fleet fleet, int crewCount) => new()
    {
        ...
        AutoResolveOverTime = fleet.AutoResolveOverTime,
        BaseAutoResolveHours = fleet.BaseAutoResolveHours,
        ChangeAutoResolveTimerOnFirstReject = fleet.ChangeAutoResolveTimerOnFirstReject,
        AutoResolveHoursAfterFirstReject = fleet.AutoResolveHoursAfterFirstReject,
