...
public static class CrewMapper
{
    public static CrewDto MapCrew(Crew crew, int memberCount, decimal monthlyGivingCapacity = 0m) => new()
    {
        ...
        AutoResolveOverTime = crew.AutoResolveOverTime,
        BaseAutoResolveHours = crew.BaseAutoResolveHours,
        ChangeAutoResolveTimerOnFirstReject = crew.ChangeAutoResolveTimerOnFirstReject,
        AutoResolveHoursAfterFirstReject = crew.AutoResolveHoursAfterFirstReject,
