        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatRooms_Crews_CrewId",
                        column: x => x.CrewId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatRoomMessages_Users_AuthorUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatRoomMessages_AuthorUserId",
                table: "ChatRoomMessages",
                column: "AuthorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatRoomMessages_ChatRoomId_Id",
                table: "ChatRoomMessages",
