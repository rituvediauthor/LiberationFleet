...
namespace LiberationFleet.Server.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260910160433_SyncModelSnapshotAfterGeoAndTiers")]
    partial class SyncModelSnapshotAfterGeoAndTiers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.CrewAllowedZipCode", b =>
                {
                    b.Property<int>("CrewId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CrewId", "ZipCode");

                    b.HasIndex("ZipCode");

                    b.ToTable("CrewAllowedZipCodes");
                });
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.EncryptedContentEnvelope", b =>
                {
                    ...
                    b.ToTable("EncryptedContentEnvelopes", t =>
                        {
                            t.HasCheckConstraint("CK_EncryptedContentEnvelopes_CrewOrFleet", "([CrewId] IS NOT NULL AND [FleetId] IS NULL) OR ([CrewId] IS NULL AND [FleetId] IS NOT NULL) OR ([CrewId] IS NULL AND [FleetId] IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.FleetAllowedZipCode", b =>
                {
                    b.Property<int>("FleetId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("FleetId", "ZipCode");

                    b.HasIndex("ZipCode");

                    b.ToTable("FleetAllowedZipCodes");
                });
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.ForumLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ForumLikes", t =>
                        {
                            t.HasCheckConstraint("CK_ForumLikes_PostOrComment", "([ForumPostId] IS NOT NULL AND [ForumCommentId] IS NULL) OR ([ForumPostId] IS NULL AND [ForumCommentId] IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.GiftComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GiftComments");
                });

            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.GiftLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GiftCommentId");

                    b.HasIndex("GiftId");

                    b.HasIndex("UserId", "GiftCommentId")
                        .IsUnique()
                    ...
                    b.ToTable("GiftLikes", t =>
                        {
                            t.HasCheckConstraint("CK_GiftLikes_GiftOrComment", "([GiftId] IS NOT NULL AND [GiftCommentId] IS NULL) OR ([GiftId] IS NULL AND [GiftCommentId] IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.LibraryOfferingAllowedZipCode", b =>
                {
                    ...
                    b.HasKey("OfferingId", "ZipCode");

                    b.HasIndex("ZipCode");

                    b.ToTable("LibraryOfferingAllowedZipCodes");
                });
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.LibraryTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("DaySpecific")
                        .HasColumnType("bit");

                    b.Property<bool>("DeleteOnCompletion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.Property<DateTime?>("OneShotDueAt")
                        .HasColumnType("datetime2");

                    b.Property<int?>("SpecificTimeMinutes")
                        .HasColumnType("int");

                    b.Property<bool>("TimeSpecific")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("CrewId", "IsClosed", "CreatedAt");

                    b.ToTable("LibraryTasks");
                });

            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.LibraryTaskInstance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ContributionGiftId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TaskId", "Status", "ScheduledAt");

                    b.ToTable("LibraryTaskInstances");
                });
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.ProposalCrewChatChange", b =>
                {
                    ...
                    b.Property<string>("OrderedRoomIdsJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.ProposalCrewmateAidStatChange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProposalCrewmateAidStatChanges");
                });
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<int>("DonationCampaignPhaseShownCount")
                        .HasColumnType("int");

                    b.Property<int>("DonationCampaignPhaseTarget")
                        .HasColumnType("int");

                    b.Property<int>("DonationCampaignUrgencyPhase")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.UserChatChannelOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserChatChannelOrders", t =>
                        {
                            t.HasCheckConstraint("CK_UserChatChannelOrders_CrewOrFleet", "([CrewId] IS NOT NULL AND [FleetId] IS NULL) OR ([CrewId] IS NULL AND [FleetId] IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.ForumLike", b =>
                {
                    b.HasOne("LiberationFleet.Server.Domain.Entities.ForumComment", "ForumComment")
                        .WithMany()
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.Gift", b =>
                {
                    ...
                    b.HasOne("LiberationFleet.Server.Domain.Entities.SeasonCycle", "SeasonCycle")
                        .WithMany()
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.GiftComment", b =>
                {
                    ...
                    b.HasOne("LiberationFleet.Server.Domain.Entities.GiftComment", "ParentComment")
                        .WithMany("Replies")
                        .HasForeignKey("ParentCommentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("LiberationFleet.Server.Domain.Entities.GiftComment", "ReplyToComment")
                        .WithMany()
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.GiftLike", b =>
                {
                    b.HasOne("LiberationFleet.Server.Domain.Entities.GiftComment", "GiftComment")
                        .WithMany()
                        .HasForeignKey("GiftCommentId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.LibraryTaskInstance", b =>
                {
                    b.HasOne("LiberationFleet.Server.Domain.Entities.User", "ClaimedByUser")
                        .WithMany()
                        .HasForeignKey("ClaimedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("LiberationFleet.Server.Domain.Entities.LibraryTask", "Task")
                        .WithMany("Instances")
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.ProposalCrewmateAidStatChange", b =>
                {
                    b.HasOne("LiberationFleet.Server.Domain.Entities.Proposal", "Proposal")
                        .WithOne("CrewmateAidStatChange")
                        .HasForeignKey("LiberationFleet.Server.Domain.Entities.ProposalCrewmateAidStatChange", "ProposalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LiberationFleet.Server.Domain.Entities.Proposal", b =>
                {
                    ...
                    b.Navigation("CrewmateAidStatChange");
