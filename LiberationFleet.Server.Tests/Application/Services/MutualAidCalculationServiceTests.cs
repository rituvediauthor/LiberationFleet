...

{
...

    {
        ...
        breakdown.TargetedMinorityGroupCount.Should().Be(0);
    ...
    public void CalculatePriorityScore_IncludesTargetedMinorityGroupCountInMultiplier()

    {
        ...
        user.PeopleRepresentedCount = 1;

        user.DisabilityLevel = 0;

        user.IdentityGroups = "Woman,Bipoc";
        ...
        // base = 100*1 + 1 + 0 + 0 = 101; multiplier = 1 + 0 + 2 + 1 = 4

        score.Should().Be(101m * 4m);
...
[Fact]
    ...
    public void CalculatePriorityScore_WhenOrganizer_ReturnsLastPlaceScore()
    ...
    public void CalculatePriorityScore_WhenOrganizer_LotPathDoesNotDemote()

    {
        ...
        var score = MutualAidCalculationService.CalculatePriorityScore(
            ...
            demoteOrganizerToLastPlace: false);
    ...
    public void CalculatePriorityScore_WhenOrganizerOnly_StillLastPlaceForGivingSeason()
