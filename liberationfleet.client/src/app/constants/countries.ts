/** ISO 3166-1 alpha-2 countries for postal-code scoping. */
...
export function countryName(code: string | null | undefined): string {
  ...
  return COUNTRY_OPTIONS.find(c => c.code === code.toUpperCase())?.name ?? code;
}

/** Normalize postal for client-side checks (match server: upper, strip space/hyphen). */
