...
- Create Angular project with ng: `ng new liberationfleet.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`liberationfleet.client.esproj`).
